namespace MakerJs.exporter {
    ...
    chainLinkToPathDataMap[pathType.Bezier] = function (bez: IPathBezier, endPoint: IPoint, reversed: boolean, d: ISvgPathData) {
    ...
    svgPathDataMap[pathType.Bezier] = function (bez: IPathBezier) {
        var d: ISvgPathData = [];
        svgBezierData(d, bez);
     ...
     * @private
     */
    function svgBezierData(d: ISvgPathData, bez: IPathBezier, reversed?: boolean) {
        if (bez.control) {
